...
const products = [
  ...
  { id: 6, title: "Masterclass Tajweed", description: "Masterclass avancée de 8 heures enregistrée avec un Qari certifié.", price: "69 $", type: "Vidéo", image: studentReadingImg },
];
